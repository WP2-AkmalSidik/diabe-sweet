...
<section
    ...
    <div class="w-full mt-4 flex flex-row justify-between">
        <div class="w-[70%] bg-white rounded-xl">
            <input type="text" name="" id="" placeholder="Cari Pengguna" class="w-full rounded-xl border-none placeholder-slate-400 focus:outline-none focus:border-black focus:ring-black" required>
        </div>
        <button type="button" class="w-[25%] bg-black text-white flex items-center justify-center rounded-xl">Search</button>
    </div>
    ...
    <div class="grid grid-cols-2 mt-4 w-full gap-4">
        <div class="bg-white w-full flex flex-col justify-between items-center rounded-xl p-3 gap-y-2">
            <h1 class="text-sm font-semibold text-black">Alvi Alivia Z</h1>
            
            <!-- Make if didieu jang image user -->
            <div class="h-[60px] w-[60px]">
                <img src="{{ asset('assets/user.svg') }}" alt="" class="rounded-full h-full w-full object-cover">                                          
            </div>

            <h1 class="text-sm text-center font-semibold text-black p-2">01-01-2004 <br />TASIKMALAYA</h1>
