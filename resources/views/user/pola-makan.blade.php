...
<section
    ...
    <div class="container-snap snap-x snap-mandatory overflow-x-auto w-full flex flex-row gap-5 px-[5rem] mt-7">
        <a href="#" class="snap-center flex-shrink-0 rounded-3xl overflow-hidden max-w-[16rem] object-cover"
        ...
        <a href="#" class="snap-center flex-shrink-0 rounded-3xl overflow-hidden max-w-[16rem] object-cover"
            ...
            <img src="{{asset('assets/ayam_panggang.jpg')}}" class="h-[10rem]" />
        </a>
        <a href="#" class="snap-center flex-shrink-0 rounded-3xl overflow-hidden max-w-[16rem] object-cover"
    ...
    <div class="rounded-3xl h-[62%] w-full bg-white px-8 py-4 absolute bottom-0 flex flex-col">
        ...
        <div class="flex flex-col gap-2">
            <div
                class="px-3 rounded-2xl border-2 border-green-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
            ...
            <div
                class="px-3 rounded-2xl border-2 border-blue-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
                <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        stroke="white" stroke-width="4.55279" stroke-miterlimit="10" />
                </svg>
            ...
            <div
                class="px-3 rounded-2xl border-2 border-red-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
                <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.907715" y="0.453873" width="68.0923" height="68.0923" rx="34.0461" fill="#EF4444" />
                    <path
                        ...
                        stroke="white" stroke-width="4.53949" />
                </svg>
    ...
    <!-- Modal Nutrisi -->
    <div class="fixed inset-0 z-50 flex items-center justify-center hidden" id="myModal">
        <div class="rounded-3xl h-[62%] w-full bg-white px-8 py-4 absolute bottom-0 flex flex-col">
            <p id="modalTitle" class="text-xl font-semibold text-center">Makanan</p>
            <p class="text-base font-semibold">Nilai Nutrisi</p>
            ...
            <div class="flex flex-col gap-2">
                ...
                <div
                    class="px-3 rounded-2xl border-2 border-green-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
                    <svg width="69" height="69" fill="#10B981" viewBox="0 0 69 69" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M34.5 0C15.4766 0 0 15.4766 0 34.5C0 53.5234 15.4766 69 34.5 69C53.5236 69 69.0002 53.5234 69.0002 34.5C69.0002 15.4766 53.5236 0 34.5 0Z" />
                    </svg>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div id="proteinBar" class="bg-green-500 h-full rounded-full" style="width: 0%"></div>
                    </div>
                    <h5 id="proteinPercent" class="font-semibold text-lg text-green-500">0%</h5>
                </div>

                <!-- Kadar Nutrisi Lainnya (Lemak, Karbohidrat, dll) -->
                <div
                    class="px-3 rounded-2xl border-2 border-blue-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
                    <svg width="69" height="69" fill="#3B82F6" viewBox="0 0 69 69">
                        <rect width="69" height="69" rx="34.5" />
                    </svg>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div id="nutrisiBar" class="bg-blue-500 h-full rounded-full" style="width: 0%"></div>
                    </div>
                    <h5 id="nutrisiPercent" class="font-semibold text-lg text-blue-500">0%</h5>
                </div>

                <!-- Kadar Gula -->
                <div
                    class="px-3 rounded-2xl border-2 border-red-500 w-full flex flex-row justify-between items-center gap-4 mt-2">
                    <svg width="69" height="69" fill="#EF4444" viewBox="0 0 69 69">
                        <rect width="69" height="69" rx="34.5" />
                    </svg>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div id="gulaBar" class="bg-red-500 h-full rounded-full" style="width: 0%"></div>
                    </div>
                    <h5 id="gulaPercent" class="font-semibold text-lg text-red-500">0%</h5>
                </div>
            </div>
        </div>
    </div>
...
function openModal(makanan) {
    ...
    const nutrisiBar = document.getElementById('nutrisiBar');
    const gulaBar = document.getElementById('gulaBar');
    const proteinPercent = document.getElementById('proteinPercent');
    const nutrisiPercent = document.getElementById('nutrisiPercent');
    const gulaPercent = document.getElementById('gulaPercent');
    ...
    nutrisiBar.style.width = data.nutrisi + '%';
    gulaBar.style.width = data.gula + '%';

    proteinPercent.innerText = data.protein + '%';
    nutrisiPercent.innerText = data.nutrisi + '%';
    gulaPercent.innerText = data.gula + '%';
