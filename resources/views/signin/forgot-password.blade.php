...
<section
    ...
    <p class="text-center mt-5 text-[0.8rem] text-gray-500">Masukkan akun email Anda <br> untuk mengatur ulang kata
        password</p>
    ...
    <form class="mt-7 flex flex-col justify-between h-full gap-2" method="POST" action="{{ route('password.email') }}">
        ...
        <!-- Submit Button -->
        <button type="submit"
            class="bg-[#FF76CE] px-5 py-2 rounded-md font-bold mt-5 w-full text-center text-white">Submit</button>
    </form>
</section>
@endsection